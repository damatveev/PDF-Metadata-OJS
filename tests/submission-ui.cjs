...
vm.runInNewContext(fs.readFileSync(__dirname + '/../js/submissionMetadata.js', 'utf8'), sandbox);
...
assert(!fs.readFileSync(__dirname + '/../js/submissionMetadata.js', 'utf8').includes('innerHTML'));
