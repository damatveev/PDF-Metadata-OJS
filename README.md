...
Текущая версия: **1.0.1.1**. Лицензия: GPL-3.0-or-later.

Готовые пакеты: [tar.gz](dist/pdfMetadata-1.0.1.1.tar.gz), [ZIP](dist/pdfMetadata-1.0.1.1.zip), [SHA256](dist/SHA256SUMS.txt).
