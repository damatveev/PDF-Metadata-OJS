...
Текущая версия: **1.0.1.3**. Лицензия: GPL-3.0-or-later.

Готовые пакеты: [tar.gz](dist/pdfMetadata-1.0.1.3.tar.gz), [ZIP](dist/pdfMetadata-1.0.1.3.zip), [SHA256](dist/SHA256SUMS.txt).
